...
import com.jjurisic.android.movielist.movie.fragment.interactor.MoviesInteractor;
import com.jjurisic.android.movielist.movie.fragment.interactor.MoviesInteractorImpl;
...
public class MoviesPresenterImpl implements MoviesPresenter, ResponseListener<MoviesListWrapper> {
    ...
    public void requestMoviesFromBackend(@NonNull Context from, int page, @NonNull MovieSortType type) {
        moviesInteractor.requestMovies(from, page, type, this);
        if (page == 1) {
